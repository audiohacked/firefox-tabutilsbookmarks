...
if (!Date.prototype.toMilitaryString) {
	(function() {
		...
		Date.prototype.toMilitaryString = toMilitaryString;
	}());
}

// exports.toMilitaryString = toMilitaryString;
// exports.Date;

var EXPORTED_SYMBOLS = ['toMilitaryString'];
